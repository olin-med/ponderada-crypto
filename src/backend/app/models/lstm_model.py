...
MODEL_PATH = 'backend/app/models/lstm_model.h5'
...
def train_lstm_model():
    ...
    np.save('backend/app/models/lstm_scaler.npy', scaler.scale_)
...
def get_lstm_prediction():
    ...
    scaler_scale = np.load('backend/app/models/lstm_scaler.npy')
